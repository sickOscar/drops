...
export {url, CELL_SIZE, BOARD_SIZE, VIEWER_SOCKETS, HOSTNAME, HOSTNAME_NO_PROTOCOL, AUTH_REDIRECT_URI, SLIDER_TYPE, RESOURCES_AT_END_ROUND, DEVELOPMENT_AT_END_ROUND, RELAY_ROOM, BATTLE_ROOM, LOCALSTORAGE, MULTIPLAYER_HOST, MULTIPLAYER_HOST_VIEWER, LEVELS};
